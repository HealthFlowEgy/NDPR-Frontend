...
const specializationChoices = [
    ...
    { id: 'Cardiopulmonary', name: 'Cardiopulmonary' },
...
// Filter component
const PhysiotherapistFilter = (props: any) => (
    <Filter {...props}>
        <SearchInput source="q" alwaysOn placeholder="Search physiotherapists..." />
...
// List Component
export const PhysiotherapistList = () => (
    <List 
        filters={<PhysiotherapistFilter />}
        actions={<ListActions />}
...
// Create Component
export const PhysiotherapistCreate = () => (
    <Create title="Register New Physiotherapist">
...
// Edit Component
export const PhysiotherapistEdit = () => (
    <Edit title="Edit Physiotherapist">
        <SimpleForm toolbar={<CustomToolbar />}>
            <Typography variant="h6" gutterBottom>Personal Information</Typography>
            <Box display="flex" flexDirection="column" gap={2} width="100%">
                <Box display="flex" gap={2}>
...
// Show Component
export const PhysiotherapistShow = () => (
    <Show title="Physiotherapist Details">
        <SimpleShowLayout>
            <Card sx={{ mb: 2 }}>
                <CardContent>
