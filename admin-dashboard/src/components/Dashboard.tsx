        ...
        const fetchStats = async () => {
            try {
                ...
                setStats({
                    ...
                    pending: 12, // Placeholder - would come from actual pending registrations
                    approved: (doctorsRes.total || 0) + (nursesRes.total || 0) + (pharmacistsRes.total || 0) + (physioRes.total || 0) + (dentistsRes.total || 0)
                });
            } catch (error) {
        ...
        <Box sx={{ p: 3 }}>
            ...
            <Box sx={{ mb: 4 }}>
                <Typography variant="h4" gutterBottom sx={{ fontWeight: 'bold', color: '#1976d2' }}>
                    Welcome to HealthFlow Admin
                </Typography>
                <Typography variant="body1" color="textSecondary">
                    Manage healthcare professionals and facilities across Egypt
                </Typography>
            </Box>
            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} sm={6} md={4}>
                    <StatCard
                        title="Pharmacists"
                        value={loading ? '...' : stats.pharmacists}
                ...
                <Grid item xs={12} sm={6} md={4}>
                    <StatCard
                        ...
                        value={loading ? '...' : stats.physiotherapists}
